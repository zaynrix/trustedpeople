    ...
    routes: [
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: '/secure-admin-784512/adminDashboardStatics',
            name: 'adminDashboard',
            builder: (context, state) {
              if (authState.isAdmin) {
                return const AdminDashboardStatistics();
              } else {
          ...
          GoRoute(
            ...
            builder: (context, state) {
              if (authState.isAdmin) {
                return const AdminDashboardStatusScreen();
              } else {
                return const Scaffold(
                  body: Center(child: Text('Page not found')),
                );
...
class ScreensNames {
  ...
  static const String adminDashboardStatistics = 'adminDashboardStatics';
  ...
  static const String adminDashboardPath = '/adminDashboardStatics';
