...
//
// import '../../../../../app/core/widgets/search_field.dart';
// import '../../../../../fetures/Home/uis/trusted_screen.dart';
// import '../providers/user_state.dart';
//
// class TrustedUsersScreen extends ConsumerWidget {
//   const TrustedUsersScreen({Key? key}) : super(key: key);
//
//   @override
...
// }
//
// class UntrustedUsersScreen extends ConsumerWidget {
//   const UntrustedUsersScreen({Key? key}) : super(key: key);
//
//   @override
//   Widget build(BuildContext context, WidgetRef ref) {
...
//   final String title;
//   final AsyncValue<List<User>> usersStream;
...
//                   ? a.aliasName.compareTo(b.aliasName)
//                   : b.aliasName.compareTo(a.aliasName);
//             case 'mobileNumber':
//               return sortAscending
...
//               SearchField(
//                 onChanged: (value) {
//                   userNotifier.setSearchQuery(value);
//                 },
...
//               if (!isMobile)
//                 _buildStatsFooter(context, filteredUsers.length, users.length),
//             ],
//           );
//         }
//       },
...
//     final filterMode = ref.watch(filterModeProvider);
//     final userNotifier = ref.read(userStateProvider.notifier);
//     final locations = ref.watch(locationsStreamProvider);
//
...
//             onSelected: (selected) {
//               if (selected) {
//                 userNotifier.setFilterMode(FilterMode.all);
//               }
//             },
//           ),
//           const SizedBox(width: 8),
...
//             onSelected: (selected) {
//               if (selected) {
//                 userNotifier.setFilterMode(FilterMode.withReviews);
//               }
//             },
//           ),
//           const SizedBox(width: 8),
...
//             onSelected: (selected) {
//               if (selected) {
//                 userNotifier.setFilterMode(FilterMode.withoutTelegram);
//               }
//             },
//           ),
//           const SizedBox(width: 8),
...
//           userNotifier.setSort(value);
//         } else {
//           // Set new field and reset to ascending
//           userNotifier.setSort(value, ascending: true);
//         }
//       },
//     );
//   }
...
//               onChanged: (value) {
//                 if (value != null) {
//                   userNotifier.setPageSize(value);
//                 }
//               },
//             ),
//           ),
...
//             onPressed:
//                 currentPage > 1 ? () => userNotifier.setCurrentPage(1) : null,
...
//                 ? () => userNotifier.setCurrentPage(currentPage - 1)
//                 : null,
...
//             onPressed: currentPage < totalPages
//                 ? () => userNotifier.setCurrentPage(totalPages)
//                 : null,
...
//                       onTap: () {
//                         userNotifier.setLocationFilter(location);
//                         Navigator.pop(context);
//                       },
//                     );
//                   },
...
//   }
//
//   // Helper method for building help items
...
//   }
//
//   // Helper method for building export options
...
//     String? reviews;
//     bool isTrusted =
//         title.contains('الموثوقين'); // Default based on screen type
//
//     if (!isAdmin) {
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
...
//
//                 final success = await userNotifier.addUser(
//                   aliasName: aliasName,
...
//                 formKey.currentState?.save();
//
//                 final success = await userNotifier.updateUser(
//                   id: user.id,
//                   aliasName: aliasName,
//                   mobileNumber: mobileNumber,
//                   location: location,
...
//           ElevatedButton(
//             onPressed: () async {
//               final success = await userNotifier.deleteUser(user.id);
//               if (success && context.mounted) {
//                 Navigator.pop(context);
//                 ScaffoldMessenger.of(context).showSnackBar(
//                   SnackBar(
